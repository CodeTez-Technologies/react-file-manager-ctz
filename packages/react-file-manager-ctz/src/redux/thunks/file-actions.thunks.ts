...
export const thunkUpdateRawFileActions =
  (rawFileActions: FileAction[] | any, disableDefaultFileActions: Nilable<boolean | string[]>): ExplorerThunk =>
    (dispatch) => {
...
export const thunkUpdateToolbarNContextMenuItems =
  (fileActions: FileAction[]): ExplorerThunk =>
    (dispatch) => {
...
export const thunkUpdateDefaultFileViewActionId =
  (fileActionId: Nilable<string>): ExplorerThunk =>
    (dispatch, getState) => {
...
export const thunkApplySelectionTransform =
  (action: FileAction): ExplorerThunk =>
    (dispatch, getState) => {
